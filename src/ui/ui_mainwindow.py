...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionEdit_Strings = QAction(MainWindow)
        self.actionEdit_Strings.setObjectName(u"actionEdit_Strings")
        self.actionEdit_Strings.setEnabled(False)
        self.actionClose_String_Editor = QAction(MainWindow)
        self.actionClose_String_Editor.setObjectName(u"actionClose_String_Editor")
        self.actionClose_String_Editor.setEnabled(False)
        ...
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionEdit_Strings)
        self.menuFile.addAction(self.actionClose_String_Editor)
        self.menuFile.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionEdit_Strings.setText(QCoreApplication.translate("MainWindow", u"Edit Strings...", None))
        self.actionClose_String_Editor.setText(QCoreApplication.translate("MainWindow", u"Close String Editor", None))
