...
class Ui_StringEditor(object):
    def setupUi(self, StringEditor):
        ...
        self.gridLayout.addWidget(self.pushButtonCancelString, 7, 0, 1, 1)
        ...
        self.checkBoxReverseDirection = QCheckBox(StringEditor)
        self.checkBoxReverseDirection.setObjectName(u"checkBoxReverseDirection")

        self.gridLayout.addWidget(self.checkBoxReverseDirection, 6, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButtonConfirmString, 7, 1, 1, 1)
    ...
    def retranslateUi(self, StringEditor):
        ...
        self.checkBoxReverseDirection.setText(QCoreApplication.translate("StringEditor", u"Reverse Direction", None))
